            ...
            <Card>
                <div className="grid ">
                    <div className="flex-col space-y-3 my-auto">
                        ...
                        <p className="text-gray-500 text-sm md:text-base" >Ini adalah halaman pengaduan yang berisikan pengaduan yang sebelum nya telah anda  buat</p>
                    </div>
                </div>
            </Card >
