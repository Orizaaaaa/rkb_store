  ...
  return (
    <li className="relative">
      <Link
        ...
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary bg-white text-gray-600"
        to="#"
      >
        <span
          className={`absolute -right-0.5 -top-0.5 z-1 h-2 w-2 rounded-full bg-red-500 ${notifying === false ? "hidden" : "inline"
            }`}
        >
